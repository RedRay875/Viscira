...
const API_KEY = "YOUR HUGGING FACE API"; // Hugging Face API Key
...
const createImageCards = (selectedModelLabel, imageCount, aspectRatio, promptText) => {
    ...
    const selectedModel = modelIdMap[selectedModelLabel] || selectedModelLabel;
...
const handleFormSubmit = (e) => {
    ...
    createImageCards(selectedModelLabel, imageCount, aspectRatio, promptText);
};
